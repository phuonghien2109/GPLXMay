...
class Meothi extends StatelessWidget {
  ...
  final List<ExpansionTile> _listOfExpansions1 = List<ExpansionTile>.generate(
      1,
      (i) => ExpansionTile(
            title: const Text(
              "Hệ thống biển báo",
  ...
  final List<ExpansionTile> _listOfExpansions2 = List<ExpansionTile>.generate(
      1,
      (i) => ExpansionTile(
            title: const Text(
              "Sa hình",
  ...
  final List<ExpansionTile> _listOfExpansions3 = List<ExpansionTile>.generate(
      1,
      (i) => ExpansionTile(
            title: const Text(
              "Giới thiệu",
  ...
  final List<ExpansionTile> _listOfExpansions4 = List<ExpansionTile>.generate(
      1,
      (i) => ExpansionTile(
            title: const Text(
  ...
  final List<ExpansionTile> _listOfExpansions5 = List<ExpansionTile>.generate(
      1,
      (i) => ExpansionTile(
            title: const Text(
  ...
  final List<ExpansionTile> _listOfExpansions6 = List<ExpansionTile>.generate(
      1,
      (i) => ExpansionTile(
            title: const Text(
  ...
  final List<ExpansionTile> _listOfExpansions7 = List<ExpansionTile>.generate(
      1,
      (i) => ExpansionTile(
            title: const Text(
    ...
    return DefaultTabController(
        ...
        child: Scaffold(
          appBar: AppBar(
            ...
            title: const Text('Mẹo Thi Điểm Cao'),
            ...
            children: [
              ListView(
                children: <Widget>[
                  ...
                  Product(listOfExpansions: _listOfExpansions),
                  Product(listOfExpansions: _listOfExpansions1),
                  Product(listOfExpansions: _listOfExpansions2),
                  Product(listOfExpansions: _listOfExpansions3),                 
                ],
              ),
              ListView(
                children: <Widget>[
                  ...
                  Product(listOfExpansions: _listOfExpansions4),
                  Product(listOfExpansions: _listOfExpansions5),
                  Product(listOfExpansions: _listOfExpansions5),
                  Product(listOfExpansions: _listOfExpansions6),
                  Product(listOfExpansions: _listOfExpansions7),
                ],
              )
            ],
          ),
...
class Product extends StatelessWidget {
  final List<ExpansionTile> listOfExpansions;

  const Product({Key? key, required this.listOfExpansions}) : super(key: key);
